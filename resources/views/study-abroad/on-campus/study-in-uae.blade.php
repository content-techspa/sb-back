...
@section('content')
    ...
    <div class="edu-breadcrumb-area breadcrumb-style-2 bg-image bg-image--uae">
        <div class="container">
            <div class="breadcrumb-inner">
                <div class="page-title">
                    <h1 class="title py-5 my-5">Study in UAE</h1>
                </div>
            ...
            <div class="features-grid-wrap">
                <div class="features-box features-style-3 color-primary-style edublink-svg-animate">
                    ...
                    <div class="content">
                        ...
                        <h4 class="title">40K AED - 100K AED</h4>
            ...
            <div class="row row--45">
                <div class="section-title-flex section-title" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="left-content">
                        <h2 class="title">Why Study in <span class="color-secondary">UAE </span>
                        </h2>
                        <span class="shape-line"><i class="icon-19"></i></span>
                    </div>
                    <div class="right-content">
                        <p>Study in the UAE for quality education, diverse cultures, strategic location, safety, and
                            excellent career opportunities post-graduation.</p>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-primary-style">
                        <div class="icon">
                            <img class="svgInject"
                                src="{{ asset('front/img/study-abroad/on-campus/svg-icons/quality-education.svg') }}"
                                alt="animated icon">
                        </div>
                        <div class="content">
                            <h4 class="title">Quality Education</h4>
                            <p>Gain knowledge from accredited institutions that offer degrees recognized worldwide,
                                preparing you for global opportunities.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-extra08-style">
                        ...
                        <div class="content">
                            <h4 class="title">
                                Cultural Diversity</h4>
                            <p>
                                Engage with diverse global cultures to enhance understanding and adaptability in a
                ...
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-secondary-style">
                        <div class="icon">
                            <img class="svgInject"
                                src="{{ asset('front/img/study-abroad/on-campus/svg-icons/experiance-opportunity.svg') }}"
                                alt="animated icon">
                        </div>
                        <div class="content">
                            <h4 class="title">Innovative Learning</h4>
                            <p>Experience a progressive educational environment that integrates advanced technologies and
                                strong industry connections.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-extra09-style">
                        <div class="icon">
                            <img class="svgInject"
                                src="{{ asset('front/img/study-abroad/on-campus/svg-icons/strategic-location.svg') }}"
                                alt="animated icon">
                        </div>
                        <div class="content">
                            <h4 class="title">Strategic Location</h4>
                            <p> Benefit from the UAE's central global position, offering unique opportunities for
                                international commerce and networking.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-extra10-style">
                        <div class="icon">
                            <img class="svgInject"
                                src="{{ asset('front/img/study-abroad/on-campus/svg-icons/safe-environment.svg') }}"
                                alt="animated icon">
                        </div>
                        <div class="content">
                            <h4 class="title">Safety and Stability</h4>
                            <p>Enjoy a secure and stable setting in one of the world's safest countries, ideal for personal
                ...
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-extra11-style">
                        ...
                        <div class="content">
                            ...
                            <p>Explore extensive career options in a rapidly expanding economy, particularly in finance,
                                tourism, and technology sectors.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-5">
                    <div class="brand-section-heading">
                        <div class="section-title section-left" data-sal-delay="150" data-sal="slide-up"
                            ...
                            <span class="shape-line"><i class="icon-19"></i></span>
                            <p>Top universities in UAE feature world-class facilities, diverse academic programs, expert
                                faculty, and strong global industry linkages.</p>
                ...
                <div class="col-lg-7">
                    <div class="brand-grid-wrap">
                        <div class="brand-grid">
                            <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/universities/logo-01.webp') }}"
                                alt="Brand Logo">
                        </div>
                        <div class="brand-grid">
                            <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/universities/logo-02.webp') }}"
                                alt="Brand Logo">
                        </div>
                        <div class="brand-grid">
                            <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/universities/logo-03.webp') }}"
                                alt="Brand Logo">
                        </div>
                        <div class="brand-grid">
                            <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/universities/logo-04.webp') }}"
                                alt="Brand Logo">
                        </div>
                        <div class="brand-grid">
                            <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/universities/logo-05.webp') }}"
                                alt="Brand Logo">
                        </div>
                        <div class="brand-grid">
                            <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/universities/logo-06.webp') }}"
                                alt="Brand Logo">
                        </div>
                        <div class="brand-grid">
                            <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/universities/logo-07.webp') }}"
                                alt="Brand Logo">
                        </div>
                        <div class="brand-grid">
                            <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/universities/logo-08.webp') }}"
                                alt="Brand Logo">
                        </div>
                    </div>
                </div>
    ...
    {{-- <div class="testimonial-area-2 gap-top-equal">
        <div class="container edublink-animated-shape">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up"
                        data-sal-duration="800">
                        <h2 class="title">Study Categories</h2>
                        <span class="shape-line"><i class="icon-19"></i></span>
                    </div>
                </div>
            </div>
            <div class="testimonial-activation swiper pb-5">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testimonial-slide">
                            <div class="content">
                                <div class="logo"><img class="svgInject" src="{{ asset('front/img/study-abroad/on-campus/svg-icons/foundation.svg') }}"
                                    alt="animated icon"></div>
                                <h4 class="mb-1 color-primary">Foundation</h4>
                                <p>Studying in the UAE transformed my perspective. The blend of cultures and innovative
                                    courses was incredible!
                                </p>
                            </div>                            
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-slide">
                            <div class="content">
                                <div class="logo"><img class="svgInject" src="{{ asset('front/img/study-abroad/on-campus/svg-icons/undergraduate.svg') }}"
                                    alt="animated icon"></div>
                                <h4 class="mb-1 color-primary">Undergraduate</h4>
                                <p>The UAE's universities offer top-notch education with a focus on real-world applications,
                                    preparing us for global careers.</p>
                            </div>                            
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-slide">
                            <div class="content">
                                <div class="logo"><img class="svgInject" src="{{ asset('front/img/study-abroad/on-campus/svg-icons/pre-masters.svg') }}"
                                    alt="animated icon"></div>
                                <h4 class="mb-1 color-primary">Pre Masters</h4>
                                <p>The safety and facilities here are unmatched. I felt secure and supported throughout my
                                    academic journey in the UAE.</p>
                            </div>                           
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonial-slide">
                            <div class="content">
                                <div class="logo"><img class="svgInject" src="{{ asset('front/img/study-abroad/on-campus/svg-icons/postgraduate.svg') }}"
                                    alt="animated icon"></div>
                                <h4 class="mb-1 color-primary">Postgraduate</h4>
                                <p>Networking opportunities in the UAE are phenomenal due to its strategic location and
                            ...
                            <div class="accordion">
                                <div class="accordion-item">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            What are the language requirements for studying in the UAE?
                                        </button>
                                    </h5>
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        data-bs-parent="#faq-accordion">
                                        <div class="accordion-body">
                                            <p>Most universities in the UAE teach in English, but proficiency requirements
                                                can vary. It's advisable to check specific university requirements.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        data-bs-parent="#faq-accordion">
                                        <div class="accordion-body">
                                            <p>Yes, international students can work part-time with certain restrictions.
                                                Universities often help students find suitable opportunities.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            aria-expanded="false">
                                            What are the living costs for students in the UAE?
                                        </button>
                                    </h5>
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        data-bs-parent="#faq-accordion">
                                        <div class="accordion-body">
                                            <p>Living costs can vary widely depending on the city and lifestyle, but
                                                generally, students should budget for moderate to high living expenses.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        data-bs-parent="#faq-accordion">
                                        <div class="accordion-body">
                                            <p>Many universities offer scholarships based on academic merit and other
                                                criteria. It's recommended to explore each university's offerings.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-5">
                            <div class="col-6" data-sal-delay="50" data-sal="slide-down" data-sal-duration="1000">
                                <div class="faq-thumbnail thumbnail-1">
                                    <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/faq-01.webp') }}"
                                        alt="Faq Images">
                                </div>
                            </div>
                            <div class="col-6" data-sal-delay="50" data-sal="slide-up" data-sal-duration="1000">
                                <div class="faq-thumbnail thumbnail-2">
                                    <img src="{{ asset('front/img/study-abroad/on-campus/study-in-uae/faq-02.webp') }}"
                                        alt="Faq Images">
                                </div>
                            </div>
                        </div>
