            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="banner-content">
                        <h1 class="title" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">Lyon Institute for
                            Geostrategy &
                            <span class="color-secondary">Multicultural </span>
                            Relations
                        </h1>
                        <p data-sal-delay="200" data-sal="slide-up" data-sal-duration="1000">
                            Study in France and Explore New Horizons</p>
                ...
                <div class="col-lg-6">
                    <div class="banner-thumbnail">
                        <div class="thumbnail" data-sal-delay="500" data-sal="slide-left" data-sal-duration="1000">
                            <img src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/lyon-college-cover.webp') }}"
                                alt="flag-boy Image">
                        </div>
            ...
            <div class="features-grid-wrap">
                <div class="features-box features-style-6 ">
                    <div class="icon icon-course">
                        <img class="svgInject"
                            src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/icons/global-network.svg') }}"
                            alt="animated icon">
                    </div>
                    <div class="content">
                ...
                <div class="features-box features-style-6 ">
                    <div class="icon icon-tag">
                        <img class="svgInject"
                            src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/icons/cultural-tour.svg') }}"
                            alt="animated icon">
                    </div>
                    <div class="content">
                ...
                <div class="features-box features-style-6  feature-wrapper">
                    <div class="icon certificate icon-certificate">
                        <img class="svgInject"
                            src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/icons/expert-faculty.svg') }}"
                            alt="animated icon">
                    </div>
                    <div class="content">
                ...
                <div class="features-box features-style-6 feature-wrapper">
                    <div class="icon icon-member">
                        <img class="svgInject"
                            src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/icons/career-assistance.svg') }}"
                            alt="animated icon">
                    </div>
                    <div class="content">
                ...
                <div class="col-lg-6">
                    <div class="about-image-gallery">
                        <img class="main-img-1" data-sal-delay="100" data-sal="fade-in" data-sal-duration="800"
                            src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/ligmr-01.webp') }}"
                            alt="About Image">
                        <div class="main-img-wrapper">
                            <div class="main-img-inner" data-sal-delay="100" data-sal="fade-in" data-sal-duration="800">
                                <img class="main-img-2"
                                    src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/ligmr-02.webp') }}"
                                    alt="About Image">
                            </div>
                        </div>
                        <ul class="shape-group">
    ...
    <div class="home-nine-course edu-course-area section-gap-equal bg-lighten04">
        <div class="container edublink-animated-shape">
            <div class="section-title section-center sal-animate" data-sal-delay="100" data-sal="slide-up"
                ...
                <h2 class="title">Programmes Offered</h2>
                <span class="shape-line"><i class="icon-19"></i></span>
            </div>
            <div class="row g-5">
                <!-- Start Single Course  -->
                <div class="col-xl-4 col-md-6" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                    <div class="edu-course course-style-5 course-style-10">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="#">
                                    <img src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/programmes/bba.webp') }}" alt="Course Meta">
                                </a>
                                <div class="time-top">
                ...
                <div class="col-xl-4 col-md-6" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                    <div class="edu-course course-style-5 course-style-10">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="#">
                                    <img src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/programmes/mba.webp') }}" alt="Course Meta">
                                </a>
                                <div class="time-top">
                ...
                <div class="col-xl-4 col-md-6" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                    <div class="edu-course course-style-5 course-style-10">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="#">
                                    <img src="{{ asset('front/img/study-abroad/exclusive-programs/lyon-college/programmes/mba-international-business-management.webp') }}" alt="Course Meta">
                                </a>
                                <div class="time-top">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="section-title section-left" data-sal-delay="150" data-sal="slide-up"
                            data-sal-duration="800">
                            <h2 class="title">Visit the LIGMR <br> Official Website for More <br> Information
                            </h2>
                            <a href="https://www.lyoninstitute.edu.eu/" target="_blank" class="edu-btn btn-primary">Explore LIGMR<i class="icon-4"></i></a>
                        </div>
                    </div>
                </div>
                <ul class="shape-group">
