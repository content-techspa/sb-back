                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="section-title section-left" data-sal-delay="150" data-sal="slide-up"
                            ...
                            <h2 class="title">Level 3 Diploma in <span class="color-secondary"> Children’s   </span>Learning and Development
                            </h2>
                            <span class="shape-line"><i class="icon-19"></i></span>
                            <p>Our Level 3 Diploma in Children’s Learning and Development (Early Years Educator) provides essential skills and knowledge for working in early years settings. Awarded by BIIAB, an OFQUAL-regulated body, this qualification aligns with the Early Years Educator criteria defined by the National College for Teaching and Leadership (NCTL) and meets the Statutory Framework for the Early Years Foundation Stage (EYFS) ratios.</p>
                ...
                <div class="col-lg-6">
                    <div class="about-image-gallery">
                        <img class="main-img-1"
                            src="{{ asset('front/img/programs/child-care/child-care-01.webp') }}"
                            alt="About Image">                   
                        <ul class="shape-group">
            ...
            <div class="row g-5 about-content">
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-primary-style">
                        <div class="icon">
                            <img src="{{asset('front/img/programs/child-care/icons/holistic-learning.svg')}}" alt="">
                        </div>
                        <div class="content">
                            <h4 class="title">Holistic Learning</h4>
                            <p>Acquire and demonstrate essential knowledge and skills for working with children in early years settings.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-secondary-style">
                        <div class="icon">
                            <img src="{{asset('front/img/programs/child-care/icons/career-opportunities.svg')}}" alt="">
                        </div>
                        <div class="content">
                            <h4 class="title">Career Opportunities</h4>
                            <p>Unlock diverse career paths, including roles like Early Years Educator, Child Minder, or Nursery Nurse.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-extra08-style">
                        <div class="icon">
                            <img src="{{asset('front/img/programs/child-care/icons/statutory-recognition.svg')}}" alt="">
                        </div>
                        <div class="content">
                            <h4 class="title">Statutory Recognition</h4>
                            <p>Meet NCTL criteria, ensuring your qualification is valued and respected in the early years industry.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-primary-style">
                        <div class="icon">
                            <img src="{{asset('front/img/programs/child-care/icons/path-to-success.svg')}}" alt="">
                        </div>
                        <div class="content">
                            <h4 class="title">Your Path to Success</h4>
                            <p>Ascend to higher-level positions such as Nursery Supervisor, Nursery Manager, or Pre-school Manager.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="why-choose-box-2 features-box color-secondary-style">
                        <div class="icon">
                            <img src="{{asset('front/img/programs/child-care/icons/continued-learning.svg')}}" alt="">
                        </div>
                        <div class="content">
                            <h4 class="title">Continued Learning</h4>
                            <p>Progress to a Foundation Degree in Early Years, opening doors to advanced learning and leadership roles.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="edu-cta-banner">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            <h2 class="title">Shape the Future of Early<span class="color-secondary"> Childhood </span>Education</h2>
                            <p>Antai is dedicated to nurturing the next generation of early childhood professionals. Our programs provide the skills and knowledge needed to excel in children's learning and development. Enrol now to start a rewarding career in early childhood education.</p>
    ...
    <div class="home-one-cta-two cta-area-1 section-gap-equal">
        <div class="container">
            <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                ...
                <span class="shape-line"><i class="icon-19"></i></span>
                <p>For more information, email us at <a href="mailto:mg@antaifintechglobal.com">mg@antaifintechglobal.com</a>. <br>Your future education starts here in your early years!</p>
            </div>
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    <div class="home-one-cta edu-cta-box bg-image">
                        <div class="inner">
                            <div class="content text-md-end">
                                ...
                                <h3 class="title"><a href="mailto:mg@antaifintechglobal.com">mg@antaifintechglobal.com</a></h3>
                            </div>
                            <div class="sparator">
                                <span>or</span>
                            </div>
