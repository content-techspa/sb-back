...
<head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Antai - Admin & Dashboard </title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Antai Admin & Dashboard " name="description" />
        ...
        @include('administration.template.css')
    ...
    <body>
        ...
        <div id="layout-wrapper">
            ...
            @include('administration.template.navbar')


            @include('administration.template.modal')

            @include('administration.template.sidebar')
        ...
        @include('administration.template.js')
