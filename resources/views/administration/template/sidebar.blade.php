            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarnews" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                        <i class="bx bx-news"></i> <span data-key="t-authentication">Blogs</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarnews">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('administration/blogs') }}" class="nav-link" data-key="t-signin"> Blogs
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="collapse menu-dropdown" id="sidebarnews">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('administration/blog-categories') }}" class="nav-link" data-key="t-signin"> Blog Categories
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="collapse menu-dropdown" id="sidebarnews">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('administration/blog-tags') }}" class="nav-link" data-key="t-signin"> Blog Tags
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarnews" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                        <i class="bx bx-news"></i> <span data-key="t-authentication">Geo</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarnews">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('administration/countries') }}" class="nav-link" data-key="t-signin"> Countries
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="collapse menu-dropdown" id="sidebarnews">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('administration/states') }}" class="nav-link" data-key="t-signin"> States
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="collapse menu-dropdown" id="sidebarnews">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('administration/cities') }}" class="nav-link" data-key="t-signin"> Cities
                                </a>
                            </li>
                        </ul>
                    </div>
