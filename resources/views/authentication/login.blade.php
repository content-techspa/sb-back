...
<head>
    <meta charset="utf-8" />
    <title>Sign In | Antai - Admin & Dashboard </title>
                                    ...
                                    <div class="card auth-card bg-primary h-100 border-0 shadow-none p-sm-3 overflow-hidden mb-0">
                                        <div class="card-body p-4 d-flex justify-content-between flex-column">
                                            <div class="auth-image mb-3">
                                                <img src="{{ asset('backend/img/logo-main.webp') }}" alt="" height="50" />
                                            ...
                                            <div class="text-center text-white-75">
                                                <p class="mb-0">
                                                    &copy; <script>document.write(new Date().getFullYear())</script> Antai. Crafted with <i class="mdi mdi-heart text-danger"></i> by Techspa Central
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mb-0 border-0 shadow-none">
                                        <div class="card-body px-0 p-sm-5 m-lg-4">
                                            <div class="text-center mt-2">
                                                ...
                                                <p class="text-muted">Sign in to continue to Antai.</p>
                                            </div>
                                            <div class="p-2 mt-5">
